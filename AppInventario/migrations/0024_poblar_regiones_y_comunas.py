...
def create_regions_and_comunas(apps, schema_editor):
    Region = apps.get_model('AppInventario', 'Region')
    Comuna = apps.get_model('AppInventario', 'Comuna')

    regiones_comunas = {
        "Región de Arica y Parinacota": ["Arica", "Camarones", "Putre", "General Lagos"],
        "Región de Tarapacá": ["Iquique", "Alto Hospicio", "Pozo Almonte", "Camiña", "Colchane", "Huara", "Pica"],
        "Región de Antofagasta": ["Antofagasta", "Mejillones", "Sierra Gorda", "Taltal", "Calama", "Ollagüe", "San Pedro de Atacama", "María Elena"],
        ...
        "Región Aisén del General Carlos Ibáñez del Campo": ["Coyhaique", "Lago Verde", "Aysén", "Cisnes", "Guaitecas", "Chile Chico", "Cochrane", "O'Higgins", "Tortel", "Capitán Prat", "Río Ibáñez"],
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(create_regions_and_comunas),
    ]
